...
<nav class="nav">
		...
		<ul class="nav-list nav-list-larger">
            ...
            <li class="nav-item">
              <a href="${root }menu/orange_do" class="meun-item nav-link">YELLOW</a>
            </li>
            <li class="nav-item">
              <a href="#" class="meun-item nav-link">GREEN</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item nav-item-hidden">
             ...
             <c:choose>
            <c:when test="${loginUserBean.logLogin == true}">
            	
           	<li>
           			<p class="idfont">${loginUserBean.user_id }님</p>
           ...
           <ul id="hide2" class="hide2">
                <li id="hide2Blank"></li>
                <li><i class="far fa-heart"></i><a href="${root }user/userinfo.do">MyPage</a></li>
