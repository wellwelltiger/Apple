...
<head>
  ...
  <link rel="stylesheet" href="${root }css/orange.css" />
  ...
  <main>
    ...
    <div class="item1">
      <div class="item1Content">
        ...
        <div class="itemBtn1">
          <div><button class="itemMore1">더 알아보기 </button><i class="fas fa-chevron-right"></i></div>
          <div>
          
          <form action="${root }menu/detail">
          <button class="itemBuy1">구매하기</button><i class="fas fa-chevron-right"></i>
    ...
    <div class="item5">
      <div class="item5Content">
        <div class="content-title"><h1 class="title1">특별한 시즌</h1><h1 class="title2">빛나는 선물</h1></div>
        <p>면역력을 강화해줄 파인애플을</p>
        <p>오늘 바로 주문하세요.</p>
        <div class="itemBtn1">
          <div><button class="itemMore1">더 알아보기 </button><i class="fas fa-chevron-right"></i></div>
    ...
    <div class="itemBox">
      <div id="card1" class="card1">
        <div class="card1Content">
          ...
          <p>지금 바로 구매하세요.</p>
          <div class="itemBtn2">
            <div><button class="itemMore2">더 알아보기 </button><i class="fas fa-chevron-right"></i></div>
            <div><button class="itemBuy2">가격보기 </button><i class="fas fa-chevron-right"></i>
            </div>
          </div>  
      ...
      <div class="card2">
        <div class="card2Content">
          ...
          <div class="itemBtn2">
            <div><button class="itemMore2">더 알아보기 </button><i class="fas fa-chevron-right"></i></div>
            <div><button class="itemBuy2">구입하기 </button><i class="fas fa-chevron-right"></i>
            </div>
          </div>  
        </div>
      </div>
